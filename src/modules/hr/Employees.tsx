                  ...
                  filtered.map(emp => {
                    ...
                    return (
                      <TableRow key={emp.id} className="hover:bg-muted/50 transition">
                        ...
                        <TableCell className="font-semibold text-primary">{emp.employeeId}</TableCell>
                        ...
                        <TableCell>
                          <Badge variant="outline" className="text-lg font-bold text-primary border-primary/30">
                            {ctcLPA > 0 ? `${ctcLPA} LPA` : '-'}
                          </Badge>
                        </TableCell>
