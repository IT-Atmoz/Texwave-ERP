...
export default function PayrollPreparation() {
          ...
          (statusSnap) => {
            ...
            const rows = employees.map((emp) => {
              ...
              const row: PayrollRow = {
                ...
                ldPay: 0,
                otAmount: 0,
                otMinutes: otMinutes + sundayOtMinutesForWorkers,
                haDays: sundayCountForStaff,
                holidayPay: 0,
  ...
  }, [selectedMonth, employees, allLoans, attendanceApprovals, bonuses, otRates, timesheetSummaries]);
  ...
  const recalculateRow = (
    ...
    const holidayPay = row.haDays * 500;
    ...
    if (grossPayable > 0) {
      ...
      specialAllowance =
        Number(((emp.salary.specialAllowance || 0) * ratio).toFixed(2)) +
  ...
  const generatePayslipPDF = async (row: PayrollRow) => {
    ...
    const incomeItems = [
      ...
      { label: 'Night Differential', amount: row.holidayPay },
    ];
              ...
              <Table className="text-sm">
                <TableHeader>
                  <TableRow className="bg-slate-100">
                    ...
                    <TableHead>HA Days</TableHead>
                    <TableHead>Holiday Pay</TableHead>
                    <TableHead>Add SP Allowance</TableHead>
                ...
                <TableBody>
                  {payroll.map((row, idx) => {
                    ...
                    const empOtRate = otRates[row.empKey] || 70;
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell>
                          ₹{row.specialAllowance.toFixed(2)}
                        </TableCell>
